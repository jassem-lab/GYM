...
if($id=="0")
    {
        $sql="INSERT INTO `gym_services`(`service`, `description	`, `mail`, `motdepasse`, `idprofil`) VALUES 
        ('".$service."','".$description	."' ,'".$mail."' ,'".$motdepasse."' ,'".$idprofil."' )";
    }
else{
        $sql="UPDATE `gym_services` SET `nom`='".$nom."',`prenom`='".$prenom."',`mail`='".$mail."',`motdepasse`='".$motdepasse."',
